...
// Animations
  ...
  
  {
    ...
    title: "BugHerd ",
    type: "video",
    description: "This project highlights a clean, integrated feedback platform for web development. Through sleek 3D Animations and UI animation, it demonstrates how direct on-site pinning and Kanban-style task management streamline agency-client collaboration, replacing cluttered spreadsheets with a bold, efficient, and professional digital workflow.",
    mainImage: "2dv2t",
    coverImages: [],
    videoUrl: "2dv2",
    tags: ["Animations", "ANIMATION", "VIDEO"],
  ...
  },
  {
    ...
    type: "video",
    description: "This animated video uses clean 2D 3D Animations to illustrate the frustrations and technical inefficiencies caused by outdated digital tools. It demonstrates how modernizing legacy applications can streamline workflows and improve user experiences for modern businesses.",
    mainImage: "2dv22t",
    coverImages: [],
    videoUrl: "2dv22",
    tags: ["Animations","ANIMATION","VIDEO"],
